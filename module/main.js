...
const main = (async () => {
    ...
    motionbackground.initdotliner('#61b8ff30', '#00000010');
    ...
    <div class="nav">
        ...
        <div class="navbtn">
            ${languageData.nav.about ?? 'about'}
        </div>
        <div class="navbtn">
            ${languageData.nav.service ?? 'service'}
        </div>
        <div class="navbtn">
            ${languageData.nav.recommended ?? 'recommended picks'}
        </div>
        <div class="navbtn">
            ${languageData.nav.policy ?? 'privacy policy'}
        </div>
    </div>
    <div class="content">
        <div class="about">
        ...
        <div class="recommended">
            <span>${languageData.nav.recommended ?? 'recommended picks'}</span>
            <div class="recommended-picks">
                ...
                <div class="recommended-link"><a>Visit</a></div>
            </div>
        </div>
        <div class="contact">
        ...
        <div class="other-info">
            ...
            <!-- <a href="https://duckodes.github.io/icon">
                <svg aria-hidden="true" focusable="false" class="octicon octicon-file-directory-fill icon-directory" viewBox="0 0 16 16" width="30" height="30" fill="currentColor" display="inline-block" overflow="visible" style="vertical-align:text-bottom;color: #ffc933;">
